...
void OpenWarSurface::ResetBattleViews(BattleScenario* battleScenario, const std::vector<BattleCommander*>& commanders)
{
	_battleLayer->ResetEditor(battleScenario, commanders);
