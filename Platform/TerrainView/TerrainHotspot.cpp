...
glm::vec3 TerrainHotspot::GetContentPosition2x() const
{
	...
	glm::vec3 c = _terrainView->GetTerrainPosition3(_terrainView->GetViewport()->NormalizedToLocal(glm::vec2{}));
...
glm::vec2 TerrainHotspot::GetCurrentScreenPosition1() const
{
	...
	return _terrainView->GetViewport()->NormalizedToLocal(glm::vec2{});
}
